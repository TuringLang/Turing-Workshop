...
** WARNING Consult with domain experts
   :PROPERTIES:
   :CUSTOM_ID: warning-consult-with-domain-experts
   :END:
...
** Metropolis-Hastings (MH)
   :PROPERTIES:
   :CUSTOM_ID: metropolis-hastings-mh
   :END:
...
[[./.ob-jupyter/d944644d54b9d9a76d97087f1f99a907567e3ba2.png]]
...
[[./.ob-jupyter/bbd3face0b041d4acc92f00d8a9c45db1d96c643.png]]

#+BEGIN_SRC julia
plot_trajectory_quantiles!(plot(legend=false, size=(600, 300)), predictions_mh; include_data=true)
#+END_SRC julia

[[./.ob-jupyter/cca448d55db7f5ea0cfc74ddbcaf1a71b6bb8aee.png]]
...
** So instead, let's go =NUTS=
   :PROPERTIES:
   :CUSTOM_ID: so-instead-lets-go-nuts
   :END:
...
** Automatic differentiation (AD) in Julia
   :PROPERTIES:
   :CUSTOM_ID: automatic-differentiation-ad-in-julia
   :END:

- [[https://github.com/JuliaDiff/ForwardDiff.jl][ForwardDiff.jl]]:
  forward-mode AD /(default in Turing.jl)/
- [[https://github.com/JuliaDiff/ReverseDiff.jl][ReverseDiff.jl]]:
  tape-based reverse-mode AD
- [[https://github.com/FluxML/Zygote.jl][Zygote.jl]]: source-to-source
  reverse-mode AD
- And more...

Up-and-coming

- [[https://github.com/EnzymeAD/Enzyme.jl][Enzyme.jl]]: Julia bindings
  for [[https://github.com/EnzymeAD/Enzyme.jl][Enzyme]] which ADs LLVM
  (low-level)
- [[https://github.com/JuliaDiff/Diffractor.jl][Diffractor.jl]]:
  experimental mixed-mode AD meant to replace Zygote.jl

Of importance

- [[https://github.com/JuliaDiff/ChainRulesCore.jl][ChainRulesCore.jl]]:
...
** Differentiating through =solve=
   :PROPERTIES:
   :CUSTOM_ID: differentiating-through-solve
   :END:
...
[[https://github.com/SciML/SciMLSensitivity.jl][=SciMLSensitivity.jl=]]

[[https://docs.sciml.ai/SciMLSensitivity/stable/manual/differential_equation_sensitivities/#Choosing-a-Sensitivity-Algorithm][SciMLSensitivity.jl
docs]] also provides a great overview of different approaches
