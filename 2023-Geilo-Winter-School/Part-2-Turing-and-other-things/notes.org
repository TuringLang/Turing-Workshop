...
#+RESULTS:
[[file:./.ob-jupyter/30705fc6b1645f7ec106f1d9bd5cd5e5ef676b19.svg]]
...
#+RESULTS:
[[file:./.ob-jupyter/5ce43ecf0b844d2cfbba71e7741fbe4f25e7d3c4.svg]]
...
The =saveat = 1= ensures we get solution at timesteps =[0, 1, 2, ..., 14]=
...
- Don't do any depedency-extraction of the model ⟹ can't do things like automatic marginalization
  ...
  - Also ongoing work in =TuringLang= to make a BUGS-compatible model "compiler" / parser (in colab with Andrew Thomas)
