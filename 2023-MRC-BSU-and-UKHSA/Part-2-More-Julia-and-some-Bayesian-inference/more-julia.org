...
[32m⌃[39m [90m[052768ef] [39mCUDA v4.4.1
...
[33m[1m└ [22m[39m[90m@ SciMLBase ~/.julia/packages/SciMLBase/szsYq/src/integrator_interface.jl:606[39m
#+end_example
...
#+RESULTS:
#+begin_example
[1m434×4 DataFrame[0m
[1m Row [0m│[1m kid_score [0m[1m mom_hs [0m[1m mom_iq   [0m[1m mom_age [0m
...
[90m1 ─[39m %1 = (Main.global_variable * x)[91m[1m::Any[22m[39m
[90m└──[39m      return %1
#+end_example
...
: [90m1 ─[39m %1 = (Main.constant_global_variable * x)[36m::Float64[39m
: [90m└──[39m      return %1
: 
...
Arguments
  ...
  x[36m::Float64[39m
Body[36m::Float64[39m
[90m1 ─[39m %1 = Main.my_func_unstable(x)[91m[1m::Any[22m[39m
[90m│  [39m %2 = Main.typeof(x)[36m::Core.Const(Float64)[39m
[90m│  [39m %3 = Core.typeassert(%1, %2)[36m::Float64[39m
[90m└──[39m      return %3
#+end_example
...
#+RESULTS:
: CodeInfo(
: [90m1 ─[39m     return 172.70000000000002
: ) => Float64
...
[90m; ┌ @ promotion.jl:411 within `*`[39m
